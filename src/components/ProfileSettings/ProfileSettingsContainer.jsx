        ...
        <form className="form" onSubmit={onSubmitSettings}>
          ...
          <div className="item">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({
                  type: "USER_NAME_SETTINGS_HANDLER",
                  name: e.target.value,
                })
              }
              value={userData.name}
          ...
          <div className="item">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({
                  type: "USER_EMAIL_SETTINGS_HANDLER",
          ...
          <div className="item">
            ...
            <Select
              ...
              onChange={(e) =>
                dispatch({
                  type: "USER_GENDER_SETTINGS_HANDLER",
          ...
          <div className="item">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({
                  type: "USER_AGE_SETTINGS_HANDLER",
                  age: e.target.value,
                })
              }
              value={userData.info.age}
            />
          </div>
          <div className="item">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch({
                  type: "USER_CITY_SETTINGS_HANDLER",
                  city: e.target.value,
                })
              }
              value={userData.info.city}
            />
          </div>
