...
import {
  USER_STATUS_TEXT_HANDLER,
  USER_NAME_SETTINGS_HANDLER,
  USER_EMAIL_SETTINGS_HANDLER,
  USER_PHOTO_SETTINGS_HANDLER,
  USER_PROFILE_PIC_HANDLER,
  USER_GENDER_SETTINGS_HANDLER,
  USER_AGE_SETTINGS_HANDLER,
  USER_CITY_SETTINGS_HANDLER,
  ...
  switch (action.type) {
    ...
    case USER_GENDER_SETTINGS_HANDLER: {
      return {
        ...
        userData: {
          ...state.userData,
          info: { ...state.userData.info, gender: action.gender },
        },
      };
    }
    case USER_AGE_SETTINGS_HANDLER: {
      return {
        ...
        userData: {
          ...state.userData,
          info: { ...state.userData.info, age: action.age },
        },
      };
    }
    case USER_CITY_SETTINGS_HANDLER: {
      return {
        ...
        userData: {
          ...state.userData,
          info: { ...state.userData.info, city: action.city },
        },
      };
    }
    ...
    case SET_USER_INFO_AFTER_LOGIN: {
      ...
      let userDataCopy = { ...action.userData } || state.userData;
...
export const fetchAndDispatchProfilePicThunkCreator = (
  formData,
  setLoaderProfPic
) => {
  return (dispatch) => {
...
export const fetchAndDispatchAvatarThunkCreator = (
  formData,
  setLoaderAvatar
) => {
  return (dispatch) => {
